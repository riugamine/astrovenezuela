...
export const productVariants = [
  {
    ...
    color: 'Negro',
    stock: 10,
    image_url: 'https://mhldtcjzkmgolvqjwnro.supabase.co/storage/v1/variants/camiseta-sport-pro-negro-s.jpg',
  ...
  },
  {
    ...
    color: 'Azul',
    stock: 10,
    image_url: 'https://mhldtcjzkmgolvqjwnro.supabase.co/storage/v1/variants/shorts-training-elite-azul-l.jpg',
    created_at: new Date().toISOString()
  }
];